...
<motion.div variants={variants} className='p-2'>
    <h2>
        ...
        <svg className='stroke-yellow-300' xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round">
  <motion.path 
  ...
  transition={{duration:3}}
   d="M23 12c0 5.523-4.477 10-10 10s-10-4.477-10-10c0-5.523 4.477-10 10-10s10 4.477 10 10zm-6 0h-4v-4h4v4z"/>
        ...
        initial={{opacity:0}}
         ...
         onSubmit={() => alert("thanks!! dudde")} className='*:m-1 w-1/2 *:rounded-sm'>

<input type='text' required placeholder='emial'></input>
<input type='text' required placeholder='emial'></input>
<button type='submit' className='block subscribe-btn p-1 w-full' >submit</button>
