...
useEffect(() => {
  ...
  return (
    <div className={`${contactModal ? "fixed flex justify-center items-center bg-Lavender bg-opacity-70 delay-100 transition-opacity top-0 bottom-0 z-50" : ""}`}>
      

      <div ref={ContactRef} className={` fixed ${contactModal ?"duration-200 transition-all shadow p-3 rounded *:opacity-100" : "top-1/3  hover:shadow-2xl hover:shadow-Coral shadow rounded-full left-5 z-10"} bg-white *:px-3 *:py-5`}>
